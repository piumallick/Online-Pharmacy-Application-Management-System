...
LOAD DATA INFILE '/data/1store.csv' 
INTO TABLE store 
...
LOAD DATA INFILE '/data/2customers.csv' 
...
LOAD DATA INFILE '/data/3staff.csv' 
INTO TABLE staff 
FIELDS TERMINATED BY ',' 
ENCLOSED BY '"'
LINES TERMINATED BY '\n'
...
LOAD DATA INFILE '/data/4medicine.csv' 
INTO TABLE medicine 
FIELDS TERMINATED BY ',' 
ENCLOSED BY '"'
LINES TERMINATED BY '\n'
...
LOAD DATA INFILE '/data/5medicine_category.csv' 
...
LOAD DATA INFILE '/data/6supplier.csv' 
INTO TABLE supplier 
FIELDS TERMINATED BY ',' 
ENCLOSED BY '"'
LINES TERMINATED BY '\n'
...
/* Load Data script for STORE table */
LOAD DATA INFILE '/data/7stock.csv' 
INTO TABLE stock 
FIELDS TERMINATED BY ',' 
ENCLOSED BY '"'
LINES TERMINATED BY '\n'
...
LOAD DATA INFILE '/data/8has_stock_supply.csv' 
...
LOAD DATA INFILE '/data/9has_store_stock.csv' 
...
LOAD DATA INFILE '/data/10orders.csv' 
INTO TABLE orders 
FIELDS TERMINATED BY ',' 
ENCLOSED BY '"'
LINES TERMINATED BY '\n'
...
LOAD DATA INFILE '/data/11order_items.csv' 
